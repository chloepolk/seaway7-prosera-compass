...
export const TENDER_PACKAGES: TenderPackage[] = [
  ...
  },
  {
    ...
    stage: "outcome_roi",
    budget: 3_315_000,
    targetSavings: 384_800,
    realisedSavings: 404_300,
    tenderCost: 28_600,
    ownerRole: "Vessel & Marine Assurance Lead",
    sponsorRole: "SCM Director",
    confidence: 0.92,
    ...
    openedAt: "2026-05-28",
    bidders: 1,
    narrative: "Exercised the 30-day option on HeavyLift Installer I at the firm-period rate of €78,200/day, avoiding the spot-market HLCV rate of ~€88,320/day for the foundation completion window. Knock-for-knock and marine warranty terms carried unchanged from the executed charter.",
    risk: "Closed — option exercised inside the notice window; exposure retired.",
    evidence: [
      "SUPPLYTIME 2026 Box 9: hire €78,200/day; Box 7: 180 days firm plus 30-day option.",
      "Spot HLCV market assessed at €88,320–€91,540/day for Q3 2026.",
      "Savings: 30 days × (€88,688 − €78,200) ≈ €315k gross, €286k net of option notice costs.",
...
export const CLOSED_PACKAGES: ClosedPackage[] = [
  { id: "PKG-2087", name: "Monopile Primary Steel — Batch 1", cost: 93_600, realisedSavings: 2_782_000, completionDate: "2026-02-19", decisionMaker: "SCM Director" },
  { id: "PKG-2090", name: "Scour Protection Rock Supply", cost: 40_300, realisedSavings: 832_000, completionDate: "2026-03-12", decisionMaker: "SCM Director" },
  { id: "PKG-2092", name: "Cable Protection Systems", cost: 33_800, realisedSavings: 539_500, completionDate: "2026-04-02", decisionMaker: "Senior Project SCM Manager" },
  { id: "PKG-2095", name: "Marshalling Port Services — Rotterdam", cost: 49_400, realisedSavings: 1_014_000, completionDate: "2026-05-07", decisionMaker: "SCM Director" },
  { id: "PKG-2098", name: "ROV Survey & Inspection Spread", cost: 31_200, realisedSavings: 462_800, completionDate: "2026-06-04", decisionMaker: "Vessel & Marine Assurance Lead" },
]
