...
export const DOCUMENTS: S7Document[] = [
  ...
  },
  {
    ...
    pages: 2,
    summary: `Time charter for ${CHARTER.vessel} (${CHARTER.vesselType}) — ${CHARTER.charterPeriod} at ${formatActiveUsd(CHARTER.hireRate, false)}/day, knock-for-knock liabilities, SOLAS/MARPOL warranty, English law and London arbitration.`,
    fullText: [
      ...
      `Charter period: ${CHARTER.charterPeriod}. Delivery: ${CHARTER.deliveryPort}. Hire: ${formatActiveUsd(CHARTER.hireRate, false)}/day. Mobilisation: ${formatActiveUsd(CHARTER.mobilisationFee, false)} lump sum.`,
