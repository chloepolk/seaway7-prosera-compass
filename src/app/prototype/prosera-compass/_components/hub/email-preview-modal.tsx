...
Flagging this from the Action Board — ${mission.name}.

${narrative}

Target: ${formatCurrency(mission.projectedValue)} by ${new Date(mission.targetCompletionAt).toLocaleDateString()}.

Let me know if you have questions or need anything from me to move this forward.
