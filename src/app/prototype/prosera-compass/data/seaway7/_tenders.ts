...
export const TENDER_PACKAGES: TenderPackage[] = [
  ...
  },
  {
    ...
    openedAt: "2026-06-22",
    bidders: 2,
    narrative: "Replacement main hoist hook block for the chartered HLCV, drafted against TS-HL-CB-003 with DNV-OS-H101 marine-operations compliance and EN 10204 Type 3.2 certification. The draft ITT is assembled and awaiting SCM Director approval before issue to the two qualified forging houses.",
    ...
    evidence: [
      ...
      "EN 10204 Type 3.2 witness certification (DNV/Lloyd's) required before shipment.",
    ],
    involvesVessel: true,
  ...
  },
  {
    ...
    openedAt: "2026-06-15",
    bidders: 4,
    narrative: "ITT issued to four foundries for 480 Al-Zn-In anode bracelets against TS-CP-SACP-004. Tenders close 24 July; bid tabulation and technical conformity checks run as returns arrive. Electrochemical capacity certificates (≥2,500 Ah/kg) are a hard pass/fail gate.",
    ...
    evidence: [
      ...
      "ITT issued 03 July via SCM Portal; 4 of 4 bidders acknowledged receipt.",
