...
function buildRecommendation(
  ...
  if (result.highCommercialRisk) {
    return `Rank #${result.finalRank} with composite ${result.compositeScore}. High commercial risk: warranty reduced more than 25% below the 24-month Seaway7 standard. Prefer a higher-ranked compliant bidder unless risk is formally accepted.`
  }
