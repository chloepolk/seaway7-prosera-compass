...
import { PRICING_SPECIALIST_PROMPT } from "@/app/prototype/prosera-compass/agents/_prompts"
  ...
  try {
    ...
    const response = await callWithFallback({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `Analyze the following pricing and quote data and return your structured analysis.\n\nNavigation: ${JSON.stringify(drillState)}\n\nData:\n${JSON.stringify(context, null, 1)}`,
        },
      ],
      response_format: {
        type: "json_schema",
