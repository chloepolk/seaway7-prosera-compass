...
import { PORTFOLIO_SPECIALIST_PROMPT as PORTFOLIO_COMPASS } from "@/app/prototype/prosera-compass/agents/_prompts"
import { PORTFOLIO_SPECIALIST_PROMPT as PORTFOLIO_FE } from "@/app/prototype/future-energy/agents/_prompts"
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const PORTFOLIO_SPECIALIST_PROMPT = tenant === "future-energy" ? PORTFOLIO_FE : PORTFOLIO_COMPASS
